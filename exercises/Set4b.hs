...
countHelper :: Maybe a -> Int -> Int
countHelper ma acc = acc + maybe 1 (const 0) ma
...
largestHelper x [] = [x]
largestHelper x l = case signum (x - head l) of
                      -1 -> l
                      0  -> x:l
                      1  -> [x]


-- largestHelper signumx l 
--     |      null l   = [x]
--     | x >  head l   = [x]
--     | x <  head l   = l
--     | x == head l   = x:l
